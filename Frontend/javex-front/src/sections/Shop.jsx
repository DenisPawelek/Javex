  ...
  return (
    <Section ref={SectionRef} id="shop">
      ...
      <Right data-scroll ref={HorizontalRef}>
        ...
        <Product img={img2} title="Chłopiec" />
        <Product img={img5} title="lorem" />
        <Product img={img6} title="lorem" />
        <Product img={img7} title="lorem" />
        <Product img={img8} title="lorem" />
        <Product img={img9} title="lorem" />
        <Product img={img10} title="lorem" />
      </Right>
    </Section>
  );
};
